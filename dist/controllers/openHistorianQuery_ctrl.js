...
//
//******************************************************************************************************
System.register(['app/plugins/sdk', './../js/openHistorianConstants', './../css/query-editor.css!', 'lodash', 'jquery'], function(exports_1) {
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
    };
    var sdk_1, openHistorianConstants_1, lodash_1, jquery_1;
    ...
    return {
        ...
        execute: function() {
            OpenHistorianDataSourceQueryCtrl = (function (_super) {
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.setTargetWithQuery = function () {
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.setTargetWithElements = function () {
                    var functions = '';
                    var ctrl = this;
                    lodash_1.default.each(ctrl.functions, function (element, index, list) {
                        ...
                        else if (ctrl.datasource.templateSrv.variableExists(element.value))
                            functions += ctrl.datasource.templateSrv.replaceWithText(element.text);
                        else
                            functions += element.value;
                    });
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.setTargetWithText = function () {
                ...
                // #region Elements
                OpenHistorianDataSourceQueryCtrl.prototype.getElementSegments = function (newSegment) {
                    var ctrl = this;
                    var option = null;
                    ...
                    return this.datasource.metricFindQuery(option).then(function (data) {
                        ...
                        lodash_1.default.each(ctrl.datasource.templateSrv.variables, function (item, index, list) {
                            if (item.type == "query")
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.addElementSegment = function () {
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.segmentValueChanged = function (segment, index) {
                ...
                // #endregion
                // #region TOP N
                OpenHistorianDataSourceQueryCtrl.prototype.topNValueChanged = function () {
                    var ctrl = this;
                ...
                // #endregion
                // #region Wheres
                OpenHistorianDataSourceQueryCtrl.prototype.getWheresToEdit = function (where, index) {
                    var _this = this;
                    if (where.type === 'operator') {
                        ...
                        return this.datasource.whereFindQuery(this.filterSegment.value).then(function (data) {
                            ...
                            return lodash_1.default.filter(altSegments, function (segment) {
                                return lodash_1.default.find(_this.segments, function (x) {
                                    return x.value == segment.value;
                                }) == undefined;
                            });
                        });
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.whereValueChanged = function (where, index) {
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.getWheresToAddNew = function () {
                    var ctrl = this;
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.addWhere = function () {
                    if (this.wheres.length > 0)
                ...
                // #endregion
                // #region Filters
                OpenHistorianDataSourceQueryCtrl.prototype.getFilterToEdit = function () {
                    var ctrl = this;
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.filterValueChanged = function () {
                ...
                // #endregion
                // #region OrderBys
                OpenHistorianDataSourceQueryCtrl.prototype.getOrderBysToAddNew = function () {
                    var ctrl = this;
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.getOrderBysToEdit = function (orderBy) {
                    var _this = this;
                    var ctrl = this;
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.addOrderBy = function () {
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.orderByValueChanged = function (orderBy, index) {
                ...
                // #endregion
                // #region Functions
                OpenHistorianDataSourceQueryCtrl.prototype.getFunctionsToAddNew = function () {
                    var _this = this;
                    var ctrl = this;
                    var array = [];
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.getFunctionsToEdit = function (func, index) {
                    var ctrl = this;
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.functionValueChanged = function (func, index) {
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.addFunctionSegment = function () {
                ...
                OpenHistorianDataSourceQueryCtrl.prototype.buildFunctionArray = function () {
                    var ctrl = this;
                    ctrl.functions = [];
